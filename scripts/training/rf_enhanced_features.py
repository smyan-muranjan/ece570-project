...
def load_and_prepare_data(file_path='data/combined_allergy_weather.csv'):
...
def main():
    ...
    # Save results
    print("\n💾 Saving outputs...")
    joblib.dump(model, 'models/rf_enhanced_features_model.joblib')
    joblib.dump(features, 'models/rf_enhanced_features.joblib')
    
    with open('results/rf_enhanced_features.json', 'w') as f:
