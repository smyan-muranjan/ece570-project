...
def load_datasets():
    ...
    allergy_file = 'data/allergy_pollen_data.csv'
    weather_file = 'data/weather_cleaned.csv'
...
def save_merged_dataset(merged_df, output_file='data/combined_allergy_weather.csv'):
    """Save merged dataset"""
