...
def plot_predictions(y_test, y_test_pred, test_dates, model_name):
    ...
    plt.tight_layout()
    plt.savefig('results/rf.png', dpi=300, bbox_inches='tight')
...
def save_model_and_results(model, feature_cols, results, model_name):
    ...
    # Save model
    model_filename = f'models/rf.joblib'
    joblib.dump(model, model_filename)
    
    # Save feature columns
    feature_filename = 'models/rf_features.joblib'
    ...
    results_filename = 'results/rf.json'
    import json
